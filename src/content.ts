export const TREND_QUERIES = [
  'AI агент для бизнеса','ИИ агент для бизнеса','чат-бот для бизнеса','AI автоматизация',
  'автоматизация заявок','автоматизация продаж','автоматизация поддержки','AI администратор',
  'WhatsApp бот','Telegram бот','CRM автоматизация','AI отдел продаж',
  'теряем заявки','клиенты долго ждут ответа','OpenAI бизнес','Gemini бизнес'
] as const;
